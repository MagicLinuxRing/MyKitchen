...
static const CGFloat CSToastCornerRadius        = 20.0;//10.0;
...
//        wrapperView.layer.shadowOffset = CSToastShadowOffset;
    ...
    wrapperView.frame = CGRectMake(0.0, 0.0, wrapperWidth+CSToastCornerRadius, wrapperHeight);
    ...
    if(messageLabel != nil) {
        messageLabel.frame = CGRectMake(messageLeft+CSToastCornerRadius/2, messageTop, messageWidth, messageHeight);
